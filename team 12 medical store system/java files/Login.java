	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b1)
		{
			try
			{
				...
				if((s.compareTo("nihaas")==0)&&(s1.compareTo("nihaas")==0))
				{
					JOptionPane.showMessageDialog(null," Welcome To Medical Store  !","WELCOME",JOptionPane.INFORMATION_MESSAGE);
			   	    jf.setVisible(false);
                       new MainMenu();
				}
				else
			...
			{
			    cnt++;
			    JOptionPane.showMessageDialog(null,"You are not valid user","WARNING",JOptionPane.ERROR_MESSAGE);
			    t1.setText("");
			    p1.setText("");
			    if(cnt==3)
			    {
			         JOptionPane.showMessageDialog(null," Your 3 attempts are over ...!!!","WARNING",JOptionPane.ERROR_MESSAGE);
			         System.exit(0);
			    }
            }
